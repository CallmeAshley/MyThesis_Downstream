...
resume='/mai_nas/LSH/MRSpineSeg_Challenge_SMU/unet/ori_jig_exp1/model'
output_dir='/mai_nas/LSH/MRSpineSeg_Challenge_SMU/unet/ori_jig_exp1/'
gpu='0'
...
resume='/mai_nas/LSH/MRSpineSeg_Challenge_SMU/unet/ori_jig_exp1_1/model/'
output_dir='/mai_nas/LSH/MRSpineSeg_Challenge_SMU/unet/ori_jig_exp1_1/'
gpu='0'
python /mai_nas/LSH/MRSpineSeg_Challenge_SMU/unet/infer.py --resume $resume --output_dir $output_dir --gpus $gpu
# ------------------------------------------------------------------------------------------------------

resume='/mai_nas/LSH/MRSpineSeg_Challenge_SMU/unet/ori_jig_exp1_2/model/'
output_dir='/mai_nas/LSH/MRSpineSeg_Challenge_SMU/unet/ori_jig_exp1_2/'
gpu='0'
python /mai_nas/LSH/MRSpineSeg_Challenge_SMU/unet/infer.py --resume $resume --output_dir $output_dir --gpus $gpu
# ------------------------------------------------------------------------------------------------------

resume='/mai_nas/LSH/MRSpineSeg_Challenge_SMU/unet/ori_jig_exp2/model/'
output_dir='/mai_nas/LSH/MRSpineSeg_Challenge_SMU/unet/ori_jig_exp2/'
gpu='0'
python /mai_nas/LSH/MRSpineSeg_Challenge_SMU/unet/infer.py --resume $resume --output_dir $output_dir --gpus $gpu
# ------------------------------------------------------------------------------------------------------
############ 학습
...
resume='/mai_nas/LSH/MRSpineSeg_Challenge_SMU/unet/ori_jig_exp3/model/'
output_dir='/mai_nas/LSH/MRSpineSeg_Challenge_SMU/unet/ori_jig_exp3/'
gpu='0'
python /mai_nas/LSH/MRSpineSeg_Challenge_SMU/unet/infer.py --resume $resume --output_dir $output_dir --gpus $gpu
