...
resume='/mai_nas/LSH/MRSpineSeg_Challenge_SMU/unet/ori_jig_exp4_1/model'
output_dir='/mai_nas/LSH/MRSpineSeg_Challenge_SMU/unet/ori_jig_exp4_1/'
gpu='1'
...
resume='/mai_nas/LSH/MRSpineSeg_Challenge_SMU/unet/ori_jig_exp5/model/'
output_dir='/mai_nas/LSH/MRSpineSeg_Challenge_SMU/unet/ori_jig_exp5/'
gpu='1'
python /mai_nas/LSH/MRSpineSeg_Challenge_SMU/unet/infer.py --resume $resume --output_dir $output_dir --gpus $gpu
# ------------------------------------------------------------------------------------------------------

resume='/mai_nas/LSH/MRSpineSeg_Challenge_SMU/unet/ori_jig_exp5_1/model/'
output_dir='/mai_nas/LSH/MRSpineSeg_Challenge_SMU/unet/ori_jig_exp5_1/'
gpu='1'
python /mai_nas/LSH/MRSpineSeg_Challenge_SMU/unet/infer.py --resume $resume --output_dir $output_dir --gpus $gpu
# ------------------------------------------------------------------------------------------------------

resume='/mai_nas/LSH/MRSpineSeg_Challenge_SMU/unet/ori_jig_exp6/model/'
output_dir='/mai_nas/LSH/MRSpineSeg_Challenge_SMU/unet/ori_jig_exp6/'
gpu='1'
python /mai_nas/LSH/MRSpineSeg_Challenge_SMU/unet/infer.py --resume $resume --output_dir $output_dir --gpus $gpu
# ------------------------------------------------------------------------------------------------------
############ 학습
...
resume='/mai_nas/LSH/MRSpineSeg_Challenge_SMU/unet/ori_jig_exp7/model/'
output_dir='/mai_nas/LSH/MRSpineSeg_Challenge_SMU/unet/ori_jig_exp7/'
gpu='1'
python /mai_nas/LSH/MRSpineSeg_Challenge_SMU/unet/infer.py --resume $resume --output_dir $output_dir --gpus $gpu
