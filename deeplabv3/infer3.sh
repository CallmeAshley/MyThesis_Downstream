...
resume='/mai_nas/LSH/MRSpineSeg_Challenge_SMU/unet/permutation250/model'
output_dir='/mai_nas/LSH/MRSpineSeg_Challenge_SMU/unet/permutation250/'
gpu='3'
...
resume='/mai_nas/LSH/MRSpineSeg_Challenge_SMU/unet/permutation500/model/'
output_dir='/mai_nas/LSH/MRSpineSeg_Challenge_SMU/unet/permutation500/'
gpu='3'
python /mai_nas/LSH/MRSpineSeg_Challenge_SMU/unet/infer.py --resume $resume --output_dir $output_dir --gpus $gpu
# ------------------------------------------------------------------------------------------------------

resume='/mai_nas/LSH/MRSpineSeg_Challenge_SMU/unet/best/model/'
output_dir='/mai_nas/LSH/MRSpineSeg_Challenge_SMU/unet/best/'
gpu='3'
python /mai_nas/LSH/MRSpineSeg_Challenge_SMU/unet/infer.py --resume $resume --output_dir $output_dir --gpus $gpu
# ------------------------------------------------------------------------------------------------------

resume='/mai_nas/LSH/MRSpineSeg_Challenge_SMU/unet/deeplabv3/model/'
output_dir='/mai_nas/LSH/MRSpineSeg_Challenge_SMU/unet/deeplabv3/'
gpu='3'
python /mai_nas/LSH/MRSpineSeg_Challenge_SMU/unet/infer.py --resume $resume --output_dir $output_dir --gpus $gpu
# ------------------------------------------------------------------------------------------------------
############ 학습
...
resume='/mai_nas/LSH/MRSpineSeg_Challenge_SMU/unet/deeplabv3_nonzeroX/model/'
output_dir='/mai_nas/LSH/MRSpineSeg_Challenge_SMU/unet/deeplabv3_nonzeroX/'
gpu='3'
python /mai_nas/LSH/MRSpineSeg_Challenge_SMU/unet/infer.py --resume $resume --output_dir $output_dir --gpus $gpu
